    ...
    <div class="interjection_stripe_content_left_cta_right_one_container">
        <div class="interjection_stripe_content_left_cta_right_one_content">
            <?php if (get_field('interjection_stripe_content_left_cta_right_one_headline')) : ?>
                <h2><?php echo get_field('interjection_stripe_content_left_cta_right_single_line_one_shortcode_headline') ?></h2>
            <?php else : ?>
        ...
        <div class="interjection_stripe_content_left_cta_right_one_cta">
            <?php if (get_field('interjection_stripe_content_left_cta_right_single_line_one_shortcode_above_cta_text')) : ?>
                <h4><?php echo get_field('interjection_stripe_content_left_cta_right_single_line_one_shortcode_above_cta_text') ?></h4>
            <?php else :  ?>
                <h4>Call Us Now!</h4>
            <?php endif; ?>
