...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/contact_form_cta');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/content_left_box_right');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/image_cta_headline_sub_headline_two_buttons');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/phone_cta');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/two_long_buttons_cta');
	return ob_get_clean();
}
...
function video_cta_shortcode()
{
	...
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/video_cta');
	return ob_get_clean();
}
...
function blue_featured_content_shortcode()
{
	...
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/blue_featured_content');
	return ob_get_clean();
}
...
function treatment_questions_sidebar_shortcode()
{
	...
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/treatment_questions_sidebar');
	return ob_get_clean();
}
...
function learnAbout_sidebar_shortcode()
{
	...
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/learn_about_sidebar');
	return ob_get_clean();
}
...
function gallery_sidebar_shortcode()
{
	...
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/gallery_sidebar');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/covid19');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/two_column_gallery');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/three_column_gallery');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/learn_more_about_center');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/career_opportunities');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/two_column_bullet_list');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/centers_cards_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/centers_cards_two_rows_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/two_cta_btn_sidebar_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/learn_centers_sidebar_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/two_sentence_cta_no_btn_no_background');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/sliding_insurance_form');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/graph_tabs_1');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/graph_tabs_2');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/graph_tabs_3');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/sliding_form_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/single_graph_shortcode_1');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/single_graph_shortcode_2');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/single_graph_shortcode_3');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/single_graph_shortcode_4');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/form_testing');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/google_web_story');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/headline_and_button_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/related_pages');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/treatment_options');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/spacers/twentyfive_px_spacer');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/spacers/thirtytwo_px_spacer');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/spacers/fifty_px_spacer');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/spacers/seventyfive_px_spacer');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/spacers/onehundred_px_spacer');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/search_query_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/data_cards_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/image_left_cta_right_shortcode_dynamic');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/image_left_cta_right_shortcode_static');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/expandable_rows_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/insurance_slider_sidebar_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/insurance_slider_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/insurance_slider_shortcode_static');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/list_and_cta_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/insurance_list_and_cta_static');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/insurance_list_and_cta_static_sidebar');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/insurance_list_and_cta_universal');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/image_left_cta_right_shortcode_COVID');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/covid_cta_shortcode');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/customize_experience');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/customized_map');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/state_table');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/author_and_medical_review');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/faq_sidebar');
	return ob_get_clean();
}
...
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/non_ppc/search_form');
	return ob_get_clean();
}
